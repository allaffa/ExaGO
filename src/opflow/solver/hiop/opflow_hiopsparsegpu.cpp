...
bool OPFLOWHIOPSPARSEGPUInterface::get_prob_sizes(hiop::size_type &n,
                                                  hiop::size_type &m) {
  n = opflow->nx;
  m = opflow->ncon;
  return true;
...
bool OPFLOWHIOPSPARSEGPUInterface::eval_f(const hiop::size_type &n,
...
bool OPFLOWHIOPSPARSEGPUInterface::eval_Jac_cons(
    ...
    hiop::index_type *iJacS_dev, hiop::index_type *jJacS_dev,
    double *MJacS_dev) {
...
bool OPFLOWHIOPSPARSEGPUInterface::eval_Jac_cons(
    ...
    bool new_x, const hiop::size_type &nnzJacS, hiop::index_type *iJacS_dev,
...
bool OPFLOWHIOPSPARSEGPUInterface::eval_Hess_Lagr(
    const hiop::size_type &n, const hiop::size_type &m, const double *x_dev,
    bool new_x, const double &obj_factor, const double *lambda_dev,
    bool new_lambda, const hiop::size_type &nnzHSS, hiop::index_type *iHSS_dev,
    hiop::index_type *jHSS_dev, double *MHSS_dev) {
  PetscErrorCode ierr;
  ...
  ierr = (*opflow->modelops.computesparsehessianhiop)(
      opflow, x_dev, lambda_dev, iHSS_dev, jHSS_dev, MHSS_dev);
  CHKERRQ(ierr);
...
bool OPFLOWHIOPSPARSEGPUInterface::get_starting_point(
